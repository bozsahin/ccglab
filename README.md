...
(GCL and CLisp are ANSI but it does not come with CLOS, and they have weird locks on standard package files. This is unfortunate because some dispatch macros
