...
'(((KEY 1) (PHON I) (MORPH N) (SYN ((BCAT NP) (FEATS ((AGR |1S|))))) (SEM "I")
  ...
  ((KEY 114) (PHON ENGEM) (MORPH N) (SYN ((BCAT NP) (FEATS ((AGR |1S|)))))
   (SEM "ME") (PARAM 1.0))
  ((INDEX #:_TRC629) (KEY 115) (PARAM 1.0) (INSEM LF)
   (OUTSEM (LAM LF (LAM P (P LF)))) (INSYN ((BCAT S) (FEATS ((CASE ACC)))))
   (OUTSYN
    (((BCAT IV) (FEATS NIL)) (DIR FS) (MODAL ALL)
     (((BCAT IV) (FEATS NIL)) (DIR BS) (MODAL ALL)
      ((BCAT S) (FEATS ((CASE ACC))))))))
  ((INDEX #:_TRC630) (KEY 116) (PARAM 1.0) (INSEM LF)
   (OUTSEM (LAM LF (LAM P (P LF))))
   (INSYN ((BCAT NP) (FEATS ((AGR |3S|) (CASE NOM)))))
   (OUTSYN
    (((BCAT S) (FEATS NIL)) (DIR FS) (MODAL ALL)
     (((BCAT S) (FEATS NIL)) (DIR BS) (MODAL ALL)
      ((BCAT NP) (FEATS ((AGR |3S|) (CASE NOM))))))))
  ((INDEX #:_TRC631) (KEY 117) (PARAM 1.0) (INSEM LF)
   ...
   (OUTSYN
    ((((BCAT S) (FEATS NIL)) (DIR BS) (MODAL ALL)
     ...
     ((((BCAT S) (FEATS NIL)) (DIR BS) (MODAL ALL)
       ((BCAT NP) (FEATS ((AGR |3S|) (CASE NOM)))))
      (DIR BS) (MODAL ALL) ((BCAT NP) (FEATS ((CASE ACC))))))))
  ((INDEX #:_TRC632) (KEY 118) (PARAM 1.0) (INSEM LF)
   (OUTSEM (LAM LF (LAM P (P LF)))) (INSYN ((BCAT NP) (FEATS ((CASE ACC)))))
   (OUTSYN
    (((BCAT IV) (FEATS NIL)) (DIR FS) (MODAL ALL)
     (((BCAT IV) (FEATS NIL)) (DIR BS) (MODAL ALL)
