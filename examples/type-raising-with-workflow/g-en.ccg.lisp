...
'(((KEY 1) (PHON I) (MORPH N) (SYN ((BCAT NP) (FEATS ((AGR |1S|))))) (SEM "I")
  ...
  ((KEY 114) (PHON ENGEM) (MORPH N) (SYN ((BCAT NP) (FEATS ((AGR |1S|)))))
   (SEM "ME") (PARAM 1.0))
  ((INDEX #:_TRC373) (KEY 120) (PARAM 1.0) (INSEM LF)
   (OUTSEM (LAM LF (LAM P (P LF)))) (INSYN ((BCAT SP) (FEATS NIL)))
   (OUTSYN
    ((((BCAT S) (FEATS NIL)) (DIR BS) (MODAL ALL)
      ((BCAT NP) (FEATS ((AGR |3S|)))))
     (DIR BS) (MODAL HARMONIC)
     ((((BCAT S) (FEATS NIL)) (DIR BS) (MODAL ALL)
       ((BCAT NP) (FEATS ((AGR |3S|)))))
      (DIR FS) (MODAL HARMONIC) ((BCAT SP) (FEATS NIL))))))
  ((INDEX #:_TRC376) (KEY 123) (PARAM 1.0) (INSEM LF)
   (OUTSEM (LAM LF (LAM P (P LF)))) (INSYN ((BCAT (UP)) (FEATS ((BCONST T)))))
   (OUTSYN
    (((((BCAT S) (FEATS NIL)) (DIR BS) (MODAL ALL) ((BCAT NP) (FEATS NIL)))
      (DIR FS) (MODAL HARMONIC) ((BCAT NP) (FEATS ((LEXC P)))))
     (DIR BS) (MODAL ALL)
     (((((BCAT S) (FEATS NIL)) (DIR BS) (MODAL ALL) ((BCAT NP) (FEATS NIL)))
       (DIR FS) (MODAL HARMONIC) ((BCAT NP) (FEATS ((LEXC P)))))
      (DIR FS) (MODAL ALL) ((BCAT (UP)) (FEATS ((BCONST T))))))))
  ((INDEX #:_TRC378) (KEY 125) (PARAM 1.0) (INSEM LF)
   (OUTSEM (LAM LF (LAM P (P LF)))) (INSYN ((BCAT (UP)) (FEATS ((BCONST T)))))
   (OUTSYN
    ((((BCAT S) (FEATS NIL)) (DIR BS) (MODAL ALL) ((BCAT NP) (FEATS NIL)))
     (DIR BS) (MODAL ALL)
     ((((BCAT S) (FEATS NIL)) (DIR BS) (MODAL ALL) ((BCAT NP) (FEATS NIL)))
      (DIR FS) (MODAL ALL) ((BCAT (UP)) (FEATS ((BCONST T))))))))
  ((INDEX #:_TRC379) (KEY 126) (PARAM 1.0) (INSEM LF)
   (OUTSEM (LAM LF (LAM P (P LF)))) (INSYN ((BCAT NP) (FEATS ((HEAVY M)))))
   (OUTSYN
    (((((BCAT S) (FEATS NIL)) (DIR BS) (MODAL ALL) ((BCAT NP) (FEATS NIL)))
      (DIR FS) (MODAL ALL) ((BCAT (UP)) (FEATS ((BCONST T)))))
     (DIR BS) (MODAL HARMONIC)
     (((((BCAT S) (FEATS NIL)) (DIR BS) (MODAL ALL) ((BCAT NP) (FEATS NIL)))
       (DIR FS) (MODAL ALL) ((BCAT (UP)) (FEATS ((BCONST T)))))
      (DIR FS) (MODAL HARMONIC) ((BCAT NP) (FEATS ((HEAVY M))))))))
  ((INDEX #:_TRC385) (KEY 132) (PARAM 1.0) (INSEM LF)
   ...
   (OUTSYN
    ((((BCAT S) (FEATS NIL)) (DIR BS) (MODAL ALL)
     ...
     ((((BCAT S) (FEATS NIL)) (DIR BS) (MODAL ALL)
       ((BCAT NP) (FEATS ((AGR |2S|)))))
      (DIR FS) (MODAL HARMONIC) ((BCAT S) (FEATS NIL))))))
  ((INDEX #:_MLU458) (KEY 205) (PARAM 1.0) (INSEM LF)
   ...
   (OUTSYN
    ((((BCAT S) (FEATS NIL)) (DIR BS) (MODAL ALL) ((BCAT NP) (FEATS NIL)))
     ...
     ((((BCAT S) (FEATS NIL)) (DIR BS) (MODAL ALL) ((BCAT NP) (FEATS NIL)))
      (DIR FS) (MODAL HARMONIC) ((BCAT NP) (FEATS NIL))))))
  ((INDEX #:_MLU463) (KEY 210) (PARAM 1.0) (INSEM LF)
   (OUTSEM (LAM LF (LAM P (P LF)))) (INSYN ((BCAT NP) (FEATS NIL)))
   (OUTSYN
    (((BCAT S) (FEATS NIL)) (DIR FS) (MODAL ALL)
     (((BCAT S) (FEATS NIL)) (DIR BS) (MODAL ALL) ((BCAT NP) (FEATS NIL))))))
  ((INDEX #:_TRC389) (KEY 136) (PARAM 1.0) (INSEM LF)
   (OUTSEM (LAM LF (LAM P (P LF)))) (INSYN ((BCAT S) (FEATS NIL)))
   (OUTSYN
    ((((BCAT S) (FEATS NIL)) (DIR BS) (MODAL ALL)
      ((BCAT NP) (FEATS ((AGR |1S|)))))
