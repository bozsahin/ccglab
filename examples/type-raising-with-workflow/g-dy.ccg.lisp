...
'(((KEY 1) (PHON I) (MORPH N) (SYN ((BCAT NP) (FEATS ((AGR |1S|))))) (SEM "I")
  ...
  ((KEY 114) (PHON ENGEM) (MORPH N) (SYN ((BCAT NP) (FEATS ((AGR |1S|)))))
   (SEM "ME") (PARAM 1.0))
  ((INDEX #:_TRC710) (KEY 115) (PARAM 1.0) (INSEM LF)
   (OUTSEM (LAM LF (LAM P (P LF)))) (INSYN ((BCAT NP) (FEATS ((CASE DAT)))))
   (OUTSYN
    (((BCAT NP) (FEATS NIL)) (DIR FS) (MODAL ALL)
     (((BCAT NP) (FEATS NIL)) (DIR BS) (MODAL ALL)
      ((BCAT NP) (FEATS ((CASE DAT))))))))
  ((INDEX #:_TRC711) (KEY 116) (PARAM 1.0) (INSEM LF)
   (OUTSEM (LAM LF (LAM P (P LF)))) (INSYN ((BCAT NP) (FEATS ((CASE ERG)))))
   (OUTSYN
    (((BCAT VP) (FEATS NIL)) (DIR FS) (MODAL ALL)
     (((BCAT VP) (FEATS NIL)) (DIR BS) (MODAL ALL)
      ((BCAT NP) (FEATS ((CASE ERG))))))))
  ((INDEX #:_TRC712) (KEY 117) (PARAM 1.0) (INSEM LF)
   (OUTSEM (LAM LF (LAM P (P LF)))) (INSYN ((BCAT NP) (FEATS ((CASE ABS)))))
   (OUTSYN
    (((BCAT S) (FEATS NIL)) (DIR FS) (MODAL ALL)
     (((BCAT S) (FEATS NIL)) (DIR BS) (MODAL ALL)
      ((BCAT NP) (FEATS ((CASE ABS))))))))
  ((INDEX #:_TRC713) (KEY 118) (PARAM 1.0) (INSEM LF)
   (OUTSEM (LAM LF (LAM P (P LF)))) (INSYN ((BCAT NP) (FEATS ((CASE ERG)))))
   (OUTSYN
    ((((BCAT S) (FEATS NIL)) (DIR BS) (MODAL ALL)
      ((BCAT NP) (FEATS ((CASE ABS)))))
     ...
     ((((BCAT S) (FEATS NIL)) (DIR BS) (MODAL ALL)
       ((BCAT NP) (FEATS ((CASE ABS)))))
      (DIR BS) (MODAL ALL) ((BCAT NP) (FEATS ((CASE ERG))))))))
  ((INDEX #:_TRC714) (KEY 119) (PARAM 1.0) (INSEM LF)
