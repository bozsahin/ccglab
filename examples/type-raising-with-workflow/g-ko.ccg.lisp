...
'(((KEY 1) (PHON I) (MORPH N) (SYN ((BCAT NP) (FEATS ((AGR |1S|))))) (SEM "I")
  ...
  ((KEY 114) (PHON ENGEM) (MORPH N) (SYN ((BCAT NP) (FEATS ((AGR |1S|)))))
   (SEM "ME") (PARAM 1.0))
  ((INDEX #:_TRC689) (KEY 115) (PARAM 1.0) (INSEM LF)
   (OUTSEM (LAM LF (LAM P (P LF)))) (INSYN ((BCAT NP) (FEATS ((CASE ?C1)))))
   (OUTSYN
    (((BCAT S) (FEATS NIL)) (DIR FS) (MODAL ALL)
     (((BCAT S) (FEATS NIL)) (DIR BS) (MODAL ALL)
      ((BCAT NP) (FEATS ((CASE ?C1))))))))
  ((INDEX #:_TRC690) (KEY 116) (PARAM 1.0) (INSEM LF)
   (OUTSEM (LAM LF (LAM P (P LF)))) (INSYN ((BCAT NP) (FEATS ((CASE ?C2)))))
   (OUTSYN
    ((((BCAT S) (FEATS NIL)) (DIR BS) (MODAL ALL)
      ((BCAT NP) (FEATS ((CASE ?C1)))))
     (DIR FS) (MODAL ALL)
     ((((BCAT S) (FEATS NIL)) (DIR BS) (MODAL ALL)
       ((BCAT NP) (FEATS ((CASE ?C1)))))
      (DIR BS) (MODAL ALL) ((BCAT NP) (FEATS ((CASE ?C2))))))))
  ((INDEX #:_TRC691) (KEY 117) (PARAM 1.0) (INSEM LF)
