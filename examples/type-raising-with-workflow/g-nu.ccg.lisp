...
'(((KEY 1) (PHON I) (MORPH N) (SYN ((BCAT NP) (FEATS ((AGR |1S|))))) (SEM "I")
  ...
  ((KEY 114) (PHON ENGEM) (MORPH N) (SYN ((BCAT NP) (FEATS ((AGR |1S|)))))
   (SEM "ME") (PARAM 1.0))
  ((INDEX #:_TRC621) (KEY 115) (PARAM 1.0) (INSEM LF)
   (OUTSEM (LAM LF (LAM P (P LF)))) (INSYN ((BCAT NP) (FEATS NIL)))
   (OUTSYN
    (((BCAT S) (FEATS ((TYP A)))) (DIR FS) (MODAL ALL)
     (((BCAT S) (FEATS ((TYP A)))) (DIR BS) (MODAL ALL)
      ((BCAT NP) (FEATS NIL))))))
  ((INDEX #:_TRC622) (KEY 116) (PARAM 1.0) (INSEM LF)
   (OUTSEM (LAM LF (LAM P (P LF)))) (INSYN ((BCAT NP) (FEATS NIL)))
   (OUTSYN
    ((((BCAT S) (FEATS ((TYP A)))) (DIR BS) (MODAL ALL)
      ((BCAT NP) (FEATS NIL)))
     ...
     ((((BCAT S) (FEATS ((TYP A)))) (DIR BS) (MODAL ALL)
       ((BCAT NP) (FEATS NIL)))
      (DIR BS) (MODAL ALL) ((BCAT NP) (FEATS NIL))))))
  ((INDEX #:_TRC623) (KEY 117) (PARAM 1.0) (INSEM LF)
   (OUTSEM (LAM LF (LAM P (P LF)))) (INSYN ((BCAT NP) (FEATS NIL)))
   (OUTSYN
    (((BCAT S) (FEATS ((TYP E)))) (DIR FS) (MODAL ALL)
     (((BCAT S) (FEATS ((TYP E)))) (DIR BS) (MODAL ALL)
      ((BCAT NP) (FEATS NIL))))))
  ((INDEX #:_TRC624) (KEY 118) (PARAM 1.0) (INSEM LF)
   (OUTSEM (LAM LF (LAM P (P LF)))) (INSYN ((BCAT NP) (FEATS NIL)))
   (OUTSYN
    ((((BCAT S) (FEATS ((TYP E)))) (DIR BS) (MODAL ALL)
      ((BCAT NP) (FEATS NIL)))
