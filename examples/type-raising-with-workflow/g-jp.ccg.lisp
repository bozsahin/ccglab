...
'(((KEY 1) (PHON I) (MORPH N) (SYN ((BCAT NP) (FEATS ((AGR |1S|))))) (SEM "I")
  ...
  ((KEY 114) (PHON ENGEM) (MORPH N) (SYN ((BCAT NP) (FEATS ((AGR |1S|)))))
   (SEM "ME") (PARAM 1.0))
  ((INDEX #:_TRC592) (KEY 116) (PARAM 1.0) (INSEM LF)
   (OUTSEM (LAM LF (LAM P (P LF)))) (INSYN ((BCAT PREDP) (FEATS ((CASE DAT)))))
   (OUTSYN
    ((((BCAT S) (FEATS NIL)) (DIR BS) (MODAL ALL)
      ((BCAT NP) (FEATS ((CASE TOP)))))
     (DIR FS) (MODAL ALL)
     ((((BCAT S) (FEATS NIL)) (DIR BS) (MODAL ALL)
       ((BCAT NP) (FEATS ((CASE TOP)))))
      (DIR BS) (MODAL ALL) ((BCAT PREDP) (FEATS ((CASE DAT))))))))
  ((INDEX #:_TRC593) (KEY 117) (PARAM 1.0) (INSEM LF)
   ...
   (OUTSYN
    (((((BCAT S) (FEATS NIL)) (DIR BS) (MODAL ALL)
     ...
     (((((BCAT S) (FEATS NIL)) (DIR BS) (MODAL ALL)
       ...
       (DIR BS) (MODAL ALL) ((BCAT PREDP) (FEATS ((CASE DAT)))))
      (DIR BS) (MODAL ALL) ((BCAT NP) (FEATS ((CASE ACC))))))))
  ((INDEX #:_TRC596) (KEY 120) (PARAM 1.0) (INSEM LF)
   (OUTSEM (LAM LF (LAM P (P LF)))) (INSYN ((BCAT PREDP) (FEATS ((CASE ACC)))))
   (OUTSYN
    (((((BCAT S) (FEATS NIL)) (DIR BS) (MODAL ALL)
       ((BCAT NP) (FEATS ((CASE TOP)))))
      (DIR BS) (MODAL ALL) ((BCAT NP) (FEATS ((CASE DAT)))))
     ...
     (((((BCAT S) (FEATS NIL)) (DIR BS) (MODAL ALL)
       ...
       (DIR BS) (MODAL ALL) ((BCAT NP) (FEATS ((CASE DAT)))))
      (DIR BS) (MODAL ALL) ((BCAT PREDP) (FEATS ((CASE ACC))))))))
  ((INDEX #:_MLU605) (KEY 129) (PARAM 1.0) (INSEM LF)
   (OUTSEM (LAM LF (LAM P (P LF)))) (INSYN ((BCAT NP) (FEATS NIL)))
   (OUTSYN
    (((BCAT S) (FEATS NIL)) (DIR FS) (MODAL ALL)
     (((BCAT S) (FEATS NIL)) (DIR BS) (MODAL ALL)
      ((BCAT NP) (FEATS ((CASE TOP))))))))
  ((INDEX #:_MLU607) (KEY 131) (PARAM 1.0) (INSEM LF)
   (OUTSEM (LAM LF (LAM P (P LF)))) (INSYN ((BCAT NP) (FEATS NIL)))
   (OUTSYN
    ((((BCAT S) (FEATS NIL)) (DIR BS) (MODAL ALL)
      ((BCAT NP) (FEATS ((CASE TOP)))))
     ...
     ((((BCAT S) (FEATS NIL)) (DIR BS) (MODAL ALL)
       ((BCAT NP) (FEATS ((CASE TOP)))))
      (DIR BS) (MODAL ALL) ((BCAT NP) (FEATS ((CASE DAT))))))))
  ((INDEX #:_TRC599) (KEY 123) (PARAM 1.0) (INSEM LF)
   (OUTSEM (LAM LF (LAM P (P LF)))) (INSYN ((BCAT NP) (FEATS NIL)))
   (OUTSYN
    (((BCAT CING) (FEATS NIL)) (DIR FS) (MODAL ALL)
     (((BCAT CING) (FEATS NIL)) (DIR BS) (MODAL ALL)
      ((BCAT NP) (FEATS NIL))))))
  ((INDEX #:_TRC600) (KEY 124) (PARAM 1.0) (INSEM LF)
   (OUTSEM (LAM LF (LAM P (P LF)))) (INSYN ((BCAT NP) (FEATS NIL)))
   (OUTSYN
    ((((BCAT CING) (FEATS NIL)) (DIR BS) (MODAL ALL) ((BCAT NP) (FEATS NIL)))
     (DIR FS) (MODAL ALL)
